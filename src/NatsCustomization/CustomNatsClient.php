...
namespace FrockDev\ToolsForLaravel\NatsCustomization;
...
class CustomNatsClient extends \Basis\Nats\Client
{
    ...
    public function process(null|int|float $timeout = 0)
    {
        ...
        switch (get_class($message)) {
            ...
            case Msg::class:
                ...
                $this->handlers[$message->sid]($message);
                //todo now we will reply manually
//                if ($message->replyTo) {

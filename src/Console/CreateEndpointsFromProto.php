...
class CreateEndpointsFromProto extends Command
{
    ...
    public function abstractEndpointMethodCreate(ClassType $innerGrpcController, \Nette\PhpGenerator\Method $method, string $transportFullName): void
    {
        ...
        $innerControllerMethod->setBody(
            ...
            '$transportController->setContext($ctx);' . "\n" .
     ...
     * @return void
     */
    public function markClassesAsRemoved(string $serviceDir, string $subServiceDir, string $versionDir): void
    {
        if (file_exists('/var/www/php/app/Modules/' . $serviceDir . '/AbstractEndpoints/' . $subServiceDir . '/' . $versionDir) && is_dir('/var/www/php/app/Modules/' . $serviceDir . '/AbstractEndpoints/' . $subServiceDir . '/' . $versionDir)) {
            foreach (scandir('/var/www/php/app/Modules/' . $serviceDir . '/AbstractEndpoints/' . $subServiceDir . '/' . $versionDir) as $filePath) {
                if ($filePath === '.' || $filePath === '..' || is_dir('/var/www/php/app/Modules/' . $serviceDir . '/AbstractEndpoints/' . $subServiceDir . '/' . $versionDir . '/' . $filePath)) continue;
                if (str_ends_with($filePath, 'AbstractEndpoint.php')) {
                    $abstractEndpointContent = file_get_contents('/var/www/php/app/Modules/' . $serviceDir . '/AbstractEndpoints/' . $subServiceDir . '/' . $versionDir . '/' . $filePath);
                    $abstractEndpointContent = str_replace('/**
 * This file is generated by Frock.Dev. Do not edit it manually.
 */', '/**
 * This file is generated by Frock.Dev. Do not edit it manually.
 * @deprecated
 * @removed
 */', $abstractEndpointContent);
                    file_put_contents('/var/www/php/app/Modules/' . $serviceDir . '/AbstractEndpoints/' . $subServiceDir . '/' . $versionDir . '/' . $filePath, $abstractEndpointContent);
                }
            }
        }

    if (file_exists('/var/www/php/app/Modules/' . $serviceDir . '/InnerGrpcControllers/' . $subServiceDir . '/' . $versionDir) && is_dir('/var/www/php/app/Modules/' . $serviceDir . '/InnerGrpcControllers/' . $subServiceDir . '/' . $versionDir)) {
        foreach (scandir('/var/www/php/app/Modules/' . $serviceDir . '/InnerGrpcControllers/' . $subServiceDir . '/' . $versionDir) as $filePath) {
            if ($filePath === '.' || $filePath === '..' || is_dir('/var/www/php/app/Modules/' . $serviceDir . '/InnerGrpcControllers/' . $subServiceDir . '/' . $versionDir . '/' . $filePath)) continue;
            if (str_ends_with($filePath, 'InnerController.php')) {
                $innerGrpcControllerContent = file_get_contents('/var/www/php/app/Modules/' . $serviceDir . '/InnerGrpcControllers/' . $subServiceDir . '/' . $versionDir . '/' . $filePath);
                $innerGrpcControllerContent = str_replace('/**
 * This file is generated by Frock.Dev. Do not edit it manually.
 */', '/**
 * This file is generated by Frock.Dev. Do not edit it manually.
 * @deprecated
 * @removed
 */', $innerGrpcControllerContent);
                file_put_contents('/var/www/php/app/Modules/' . $serviceDir . '/InnerGrpcControllers/' . $subServiceDir . '/' . $versionDir . '/' . $filePath, $innerGrpcControllerContent);
            }
        }
    }
    }
        ...
        foreach (scandir('/var/www/php/protoGenerated/') as $serviceDir) {
            ...
            foreach (scandir('/var/www/php/protoGenerated/'.$serviceDir) as $subServiceDir) {
                ...
                foreach (scandir('/var/www/php/protoGenerated/'.$serviceDir.'/'.$subServiceDir) as $versionDir) {
                    ...
                    $this->markClassesAsRemoved($serviceDir, $subServiceDir, $versionDir);

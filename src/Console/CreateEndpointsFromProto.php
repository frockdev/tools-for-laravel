                ...
                foreach (scandir('/var/www/php/protoGenerated/'.$serviceDir) as $versionDir) {
                    ...
                    foreach (scandir('/var/www/php/protoGenerated/'.$serviceDir.'/'.$versionDir) as $filePath) {
                        ...
                        if (str_ends_with($filePath, 'Interface.php')) {
                            $interfacePath='/var/www/php/protoGenerated/'.$serviceDir.'/'.$versionDir.'/'.$filePath;
                            break;
                        }
                    }
                    if (!$interfacePath) throw new \Exception('Cannot find interface in /var/www/php/protoGenerated/'.$serviceDir.'/'.$versionDir.'/');
